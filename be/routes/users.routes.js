...
const { getuser, keyPins, adminKeyPin, createroom, deleteroom, endmeeting, closedoor, createsearchpin } = require("../controllers/users.controllers");
const Userrouter = express.Router();

Userrouter.get("/sse/:floors/:rooms", getuser);
Userrouter.post("/key", keyPins);
Userrouter.post("/admin-key", adminKeyPin);
Userrouter.post("/search-pin", createsearchpin);
